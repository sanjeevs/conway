...
class TestRules(unittest.TestCase):
  ...
  def test_rule_born(self):
    ...
    self.assertEqual(rules.get_next_state(self.b1, 1, 2), 1)
    self.assertEqual(rules.get_next_state(self.b1, 1, 1), 1)
    self.assertEqual(rules.get_next_state(self.b1, 2, 1), 1)
    self.assertEqual(rules.get_next_state(self.b1, 2, 2), 1)
  ...
  def test_rule_dead(self):
    ...
    self.assertEqual(rules.get_next_state(self.b1, 0, 0), 0)
    self.assertEqual(rules.get_next_state(self.b1, 0, 1), 0)
    self.assertEqual(rules.get_next_state(self.b1, 0, 2), 0)
    self.assertEqual(rules.get_next_state(self.b1, 0, 3), 0)
    self.assertEqual(self.b1.num_alive_neighbors(0,3), 1)
  ...
  def test_rule_living(self):
    ...
    self.b1.set_alive(2, 2)
    self.assertEqual(rules.get_next_state(self.b1, 0, 0), 0)
    self.assertEqual(rules.get_next_state(self.b1, 0, 1), 1)
    self.assertEqual(rules.get_next_state(self.b1, 1, 0), 1)
    self.assertEqual(rules.get_next_state(self.b1, 1, 2), 1)
    self.assertEqual(rules.get_next_state(self.b1, 2, 1), 1)
    self.assertEqual(rules.get_next_state(self.b1, 2, 2), 1)
  ...
  def test_rule_dying(self):
    ...
    self.assertEqual(rules.get_next_state(self.b1, 1, 1), 0)
    self.assertEqual(rules.get_next_state(self.b1, 3, 3), 0)
    self.assertEqual(rules.get_next_state(self.b1, 2, 0), 1)
